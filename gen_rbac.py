...
MEASUREMENT_WRITE_ROLES = [ROLE_GRID_SERVICE, ROLE_SUPER_ADMIN]  # Some measurement models have RW points (e.g., 803)

GPS_MODELS = [305]
GPS_READ_ROLES = ROLES.copy()
GPS_WRITE_ROLES = [ROLE_GRID_SERVICE, ROLE_NET_ADMIN, ROLE_SUPER_ADMIN]
